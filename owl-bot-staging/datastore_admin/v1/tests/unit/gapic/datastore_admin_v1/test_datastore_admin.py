...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert DatastoreAdminClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert DatastoreAdminClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert DatastoreAdminClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert DatastoreAdminClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert DatastoreAdminClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert DatastoreAdminClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert DatastoreAdminClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert DatastoreAdminClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(DatastoreAdminClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DatastoreAdminClient))
@mock.patch.object(DatastoreAdminAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DatastoreAdminAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DatastoreAdminClient._DEFAULT_UNIVERSE
    default_endpoint = DatastoreAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = DatastoreAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert DatastoreAdminClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert DatastoreAdminClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DatastoreAdminClient.DEFAULT_MTLS_ENDPOINT
    assert DatastoreAdminClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert DatastoreAdminClient._get_api_endpoint(None, None, default_universe, "always") == DatastoreAdminClient.DEFAULT_MTLS_ENDPOINT
    assert DatastoreAdminClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DatastoreAdminClient.DEFAULT_MTLS_ENDPOINT
    assert DatastoreAdminClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert DatastoreAdminClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        DatastoreAdminClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert DatastoreAdminClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert DatastoreAdminClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert DatastoreAdminClient._get_universe_domain(None, None) == DatastoreAdminClient._DEFAULT_UNIVERSE
...
def test_datastore_admin_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class", [
    DatastoreAdminClient, DatastoreAdminAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (DatastoreAdminClient, transports.DatastoreAdminGrpcTransport, "grpc", grpc_helpers),
    (DatastoreAdminAsyncClient, transports.DatastoreAdminGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (DatastoreAdminClient, transports.DatastoreAdminRestTransport, "rest", None),
])
def test_datastore_admin_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_datastore_admin_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_export_entities_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.export_entities in client._client._transport._wrapped_methods
        ...
        client._client._transport._wrapped_methods[client._client._transport.export_entities] = mock_object
...
@pytest.mark.asyncio
async def test_import_entities_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DatastoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_entities in client._client._transport._wrapped_methods
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.import_entities] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.create_index] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_index] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_index] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_indexes] = mock_object
...
def test_export_entities_rest_required_fields(request_type=datastore_admin.ExportEntitiesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_entities._get_unset_required_fields(jsonified_request)
...
def test_export_entities_rest_unset_required_fields():
    transport = transports.DatastoreAdminRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.export_entities._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("projectId", "outputUrlPrefix", )))
...
def test_export_entities_rest_interceptors(null_interceptor):
    transport = transports.DatastoreAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DatastoreAdminRestInterceptor(),
        )
    client = DatastoreAdminClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastoreAdminRestInterceptor, "post_export_entities") as post, \
         mock.patch.object(transports.DatastoreAdminRestInterceptor, "pre_export_entities") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = datastore_admin.ExportEntitiesRequest.pb(datastore_admin.ExportEntitiesRequest())
        ...
        client.export_entities(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_export_entities_rest_bad_request(transport: str = 'rest', request_type=datastore_admin.ExportEntitiesRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_export_entities_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/projects/{project_id}:export" % client.transport._host, args[1])
...
def test_import_entities_rest_required_fields(request_type=datastore_admin.ImportEntitiesRequest):
    transport_class = transports.DatastoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_entities._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_entities_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("projectId", "inputUrl", )))
...
def test_import_entities_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastoreAdminRestInterceptor, "post_import_entities") as post, \
         mock.patch.object(transports.DatastoreAdminRestInterceptor, "pre_import_entities") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = datastore_admin.ImportEntitiesRequest.pb(datastore_admin.ImportEntitiesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.import_entities(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_import_entities_rest_bad_request(transport: str = 'rest', request_type=datastore_admin.ImportEntitiesRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_entities_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/projects/{project_id}:import" % client.transport._host, args[1])
...
def test_create_index_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project_id': 'sample1'}
    request_init["index"] = {'project_id': 'project_id_value', 'index_id': 'index_id_value', 'kind': 'kind_value', 'ancestor': 1, 'properties': [{'name': 'name_value', 'direction': 1}], 'state': 1}
...
def test_create_index_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastoreAdminRestInterceptor, "post_create_index") as post, \
         mock.patch.object(transports.DatastoreAdminRestInterceptor, "pre_create_index") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = datastore_admin.CreateIndexRequest.pb(datastore_admin.CreateIndexRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_index_rest_bad_request(transport: str = 'rest', request_type=datastore_admin.CreateIndexRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_index_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DatastoreAdminRestInterceptor, "post_delete_index") as post, \
         mock.patch.object(transports.DatastoreAdminRestInterceptor, "pre_delete_index") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = datastore_admin.DeleteIndexRequest.pb(datastore_admin.DeleteIndexRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_index_rest_bad_request(transport: str = 'rest', request_type=datastore_admin.DeleteIndexRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_index_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastoreAdminRestInterceptor, "post_get_index") as post, \
         mock.patch.object(transports.DatastoreAdminRestInterceptor, "pre_get_index") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = datastore_admin.GetIndexRequest.pb(datastore_admin.GetIndexRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_index_rest_bad_request(transport: str = 'rest', request_type=datastore_admin.GetIndexRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_indexes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastoreAdminRestInterceptor, "post_list_indexes") as post, \
         mock.patch.object(transports.DatastoreAdminRestInterceptor, "pre_list_indexes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = datastore_admin.ListIndexesRequest.pb(datastore_admin.ListIndexesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = datastore_admin.ListIndexesResponse.to_json(datastore_admin.ListIndexesResponse())
...
def test_list_indexes_rest_bad_request(transport: str = 'rest', request_type=datastore_admin.ListIndexesRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_indexes_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(datastore_admin.ListIndexesResponse.to_json(x) for x in response)
